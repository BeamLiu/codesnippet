...
def update_last_n_layers(model, n=2):
    ...
    for i in range(n-1):
        for param in model.model.layers[-1-i].parameters():
            param.requires_grad = True
...
def main():
    ...
    # Freeze and update layers
    update_last_n_layers(model, n=2)
    print("-" * 50)
    print(model)
    ...
    training_args = TrainingArguments(
        ...
        report_to="none",     # disable wandb/tensorboard logging to reduce clutter
