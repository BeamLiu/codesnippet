...
def get_lr(it: int, warmup_steps: int = 2000, max_steps: int = 100000, max_lr: float = 3e-4, min_lr: float = 3e-5):
...
def train():
    ...
    parser.add_argument("--data-dir", type=str, default="../data", help="Directory with processed token sequences")
    parser.add_argument("--ckpt-dir", type=str, default="../checkpoints", help="Directory to save checkpoints")
    parser.add_argument("--save-every", type=int, default=5000, help="Steps between checkpoints")
